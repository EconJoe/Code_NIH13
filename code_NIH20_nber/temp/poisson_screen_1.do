...
clear
gen estimate = .
save coeffs_poisson_covs_fc_2yr, replace
...
keep pmid fc_2yr ta nih post yr_* nih_post ta_post nih_ta nih_ta_post `covariates' group_* year
...
append using coeffs_poisson_covs_fc_2yr
save coeffs_poisson_covs_fc_2yr, replace
