...
merge 1:1 ngramid using medline16_ngrams_top
drop _merge
keep ngram ngramid mentions_bt vintage top_*
...
foreach h in `initialfiles' {
	...
	* Replace "abstract" and "title" to "a" and "t" to save space
	...
	order filenum pmid version ngramid year source wordcount top_* mentions_bt vintage
